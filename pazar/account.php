          ...
          <div class="col-md-6">
            <div class="aa-myaccount-register">                 
             ...
             <form action="" class="aa-login-form" method="post">
              ...
              <input type="text" name="kullaniciKadi" placeholder="Username or email">
              <label for="">Password<span>*</span></label>
              <input type="password" name="kullaniciParola" placeholder="Password">            
              <input type="checkbox" name="kullaniciBildirimAlmak" value="1"> bildirim al<br>
              <input type="checkbox" name="kullaniciUyelikSözlesmesi" value="1"> üye söz al<br>
              <button type="submit" name="btn_kayit" class="aa-browse-btn">Register</button>                    
            </form>
          </div>
        </div>
      </div>          
