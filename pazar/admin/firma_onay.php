										...
										<table class="table table-hover">
											<thead>
												<tr>
													<th>#</th>
													<th>Firma Adı</th>
													<th>Firma Hakkında</th>
													<th>Durum</th>
													<th>Onay</th>
												</tr>
											</thead>
											<?php                               
											$veri= $db->query("SELECT * FROM firma where onayDurumu='0'", PDO::FETCH_ASSOC);
											foreach($veri as $row){  
												$row['firmaId'];
												$a=$row['firmaId'];
												?>
												<tbody>
													<tr>
														<td><?php echo $row['firmaId'] ?></td>                                
														<td><?php echo $row['firmaAdi'] ?></td>
														<td><?php echo $row['firmaHakkinda'] ?></td>
											...
											if(isset($_POST['firma_onay'])){                  
												@$guncelle = $db->prepare("UPDATE firma SET onayDurumu=? WHERE firmaId =".$a."");
